...
import { Play, Users, Trophy, History, Target } from "lucide-react";
          ...
          <Card className="shadow-card">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <Button variant="sport" size="lg" onClick={() => navigate('/match/new?mode=2v2')}>
                  <Users className="mr-2 h-4 w-4" />
                  2 vs 2 Match
                  <Badge className="ml-2 bg-accent text-accent-foreground">Popular</Badge>
                </Button>
                
                <Button variant="outline" size="lg" onClick={() => navigate('/match/new?mode=1v1')}>
